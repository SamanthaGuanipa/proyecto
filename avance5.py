...
while True:
    ...
    if opcion==0:
        ...
        lista_pet=["Coca-cola","Sprite","Aceites", "Fanta"]  
        print("Algunos artículos de PET son: ", lista_pet)
        
        
        lista_pead=["Detergentes","Suavizantes","Shampoo", "Acondicionador"] 
        print("Algunos artículos de PEAD son: ", lista_pead)
        
        
        lista_pebd=["Bolsas para mascotas","Botellas","Bolsas para el aseo"]
